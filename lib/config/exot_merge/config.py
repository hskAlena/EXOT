...
cfg.TRAIN.REID_WEIGHT=3.0
cfg.TRAIN.EXIT_WEIGHT=3.0
cfg.TRAIN.GIOU_WEIGHT = 2.0
cfg.TRAIN.L1_WEIGHT = 5.0
cfg.TRAIN.CLS_WEIGHT = 1.0
cfg.TRAIN.OBJCLS_WEIGHT = 0.2
...
cfg.TRAIN.SCHEDULER.TYPE = ["step", 'Mstep']
cfg.TRAIN.SCHEDULER.DECAY_RATE = 0.1
cfg.TRAIN.SCHEDULER.MILESTONES = [50, 75]
...
cfg.DATA.TRAIN.DATASETS_OBJNUM = [14, 352]
cfg.DATA.TRAIN.DATASETS_RATIO = [1, 1]
cfg.DATA.TRAIN.SAMPLE_PER_EPOCH = 60000
# DATA.VAL
cfg.DATA.VAL = edict()
cfg.DATA.VAL.DATASETS_NAME = ["GOT10K_votval"]
cfg.DATA.VAL.DATASETS_OBJNUM = [14]
...
cfg.TEST.UPDATE_INTERVALS.ROBOT_TEST = [200]
cfg.TEST.UPDATE_INTERVALS.TREK150_TEST = [200]
