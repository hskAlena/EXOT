...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
                 ...
                 st1_name=None, resume_name=None, resume=False,
                 distill=None, script_teacher=None, config_teacher=None, dry_run=1):
    ...
    settings.st1_name = st1_name
    settings.resume_name = resume_name
...
def main():
    ...
    parser.add_argument('--dry_run', type=int, help='0: wandb activate, 1: wandb off')
    ...
    run_training(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 ...
                 st1_name=args.st1_name, resume_name=args.resume_name, resume=args.resume,
                 distill=args.distill, script_teacher=args.script_teacher, config_teacher=args.config_teacher, dry_run=args.dry_run)
