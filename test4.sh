...
# CUDA_VISIBLE_DEVICES=3 python tracking/test.py exotst_tracker baseline_mix_lowdim --dataset trek150_test --run_fn run_epsilon \
#  --modelname exot_st2 --ckpt_name baseline_mix_lowdim/EXOTST_ep0069.pth.tar --epsilon 0.00125 --threads 0 --version h --num_gpus 1 # --debug 1
# CUDA_VISIBLE_DEVICES=3 python tracking/analysis_results.py --tracker_param baseline_mix_lowdim --dataset trek150_test --name exotst_tracker \
# --modelname exot_st2 --ckpt_name baseline_mix_lowdim/EXOTST_ep0069.pth.tar 

# CUDA_VISIBLE_DEVICES=3 python tracking/test.py exotst_tracker cos_mix_lowdim_nocls --dataset robot_test --run_fn run_epsilon \
#  --modelname exot_st2 --ckpt_name cos_mix_lowdim_nocls_fold_0_5/baseline_mix_nocls_fold_0_5/STARKST_epoch=250/EXOTST_epoch=99.pth.tar \
#  --epsilon 0.00125 --threads 0 --version h --num_gpus 1 
CUDA_VISIBLE_DEVICES=3 python tracking/analysis_results.py --tracker_param cos_mix_lowdim_nocls --dataset robot_test --name exotst_tracker \
--modelname exot_st2 --ckpt_name cos_mix_lowdim_nocls_fold_0_5/baseline_mix_nocls_fold_0_5/STARKST_epoch=250/EXOTST_epoch=99.pth.tar

# CUDA_VISIBLE_DEVICES=3 python tracking/test.py exotst_tracker obj_mix_lowdim_nocls --dataset trek150_test --run_fn run_epsilon \
#  --modelname exot_st2 --ckpt_name obj_mix_lowdim_nocls_fold_0_5/baseline_mix_nocls_fold_0_5/STARKST_epoch=250/EXOTST_epoch=99.pth.tar \
#  --epsilon 0.00125 --threads 0 --version h --num_gpus 1 
...
# --modelname exot_st2 --ckpt_name baseline_mix_hs/EXOTST1_ep0070.pth.tar --epsilon 0.00125 --threads 0 --num_gpus 1 --version h --debug 1
...
# --modelname exot_st2 --ckpt_name baseline_mix_hs/EXOTST1_ep0070.pth.tar 
