...
#--mode single --script_prv exot_st1 --config_prv baseline_mix_lowdim --st1_name baseline_mix_lowdim_fold_0_5/EXOTST_epoch=113.pth.tar
#CUDA_VISIBLE_DEVICES=0 python pl_prac.py --script exot_merge --config baseline_mix_sim --save_dir . --mode single 
...
# CUDA_VISIBLE_DEVICES=1 python pl_prac.py --script exot_st2 --config cos_mix_sim --save_dir . \
# --mode single --script_prv stark_st1 --config_prv baseline_mix --st1_name baseline_mix_fold_0_5/STARKST_epoch=250.pth.tar


# CUDA_VISIBLE_DEVICES=2 python pl_prac.py --script stark_st1 --config baseline_mix --save_dir . \
# --mode single --resume True --resume_name baseline_mix_fold_0_5/STARKST_epoch=245.pth.tar
# CUDA_VISIBLE_DEVICES=2 python pl_prac.py --script exot_st2 --config cos_mix_sim --save_dir . \
# --mode single --script_prv stark_st1 --config_prv baseline_mix --st1_name baseline_mix_fold_0_5/STARKST_epoch=250-v1.pth.tar
# # CUDA_VISIBLE_DEVICES=2 python pl_prac.py --script exot_st1 --config cos_mix_lowdim_nocls --save_dir . \
# # --mode single --resume True --resume_name cos_mix_lowdim_nocls_fold_0_5/EXOTST_epoch=237.pth.tar
#CUDA_VISIBLE_DEVICES=2 python pl_prac.py --script exot_st2 --config cos_mix_lowdim --save_dir . \
#--mode single --script_prv stark_st1 --config_prv baseline_mix --st1_name baseline_mix_fold_0_5/STARKST_epoch=250.pth.tar
# --resume True --resume_name EXOTST_epoch=250/EXOTST_epoch=26.pth.tar

# CUDA_VISIBLE_DEVICES=2 python tracking/train.py --script exot_st1 --config cos_mix_lowdim \
# --save_dir . --mode single
CUDA_VISIBLE_DEVICES=2 python tracking/train.py --script exot_st2 --config cos_mix_lowdim \
--save_dir . --mode single --script_prv exot_st1 --config_prv cos_mix_lowdim \
--st1_name cos_mix_lowdim/EXOTST1_ep0250.pth.tar --resume False
