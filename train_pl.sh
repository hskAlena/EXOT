...
#CUDA_VISIBLE_DEVICES=1 python pl_prac.py --script exot_st2 --config baseline_robot_hscos --save_dir . \
#--mode single --script_prv exot_st1 --config_prv baseline_robot --st1_name baseline_robot/EXOTST_epoch=11.pth.tar \
