...
def run_tracker(tracker_name, tracker_param, run_fn='run_epsilon', epsilon=0.005, version='cos', modelname=None, ckpt_name = None, run_id=None, dataset_name='otb', sequence=None, debug=0, threads=0,
                num_gpus=8):
    ...
    trackers = [Tracker(tracker_name, tracker_param, dataset_name, modelname, ckpt_name, run_id)]

    run_dataset(dataset, trackers, run_fn, epsilon_grid, epsilon, version, debug, threads, num_gpus=num_gpus)
